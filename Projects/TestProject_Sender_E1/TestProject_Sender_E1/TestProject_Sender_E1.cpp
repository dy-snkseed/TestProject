...
// TestProject_Sender_E1.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CTestProject_Sender_E1App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CTestProject_Sender_E1App

CTestProject_Sender_E1App::CTestProject_Sender_E1App()
{
...
// Единственный объект CTestProject_Sender_E1App

CTestProject_Sender_E1App theApp;


// инициализация CTestProject_Sender_E1App

BOOL CTestProject_Sender_E1App::InitInstance()
{
	bool AlreadyRunning;

    HANDLE hMutexOneInstance = ::CreateMutex( NULL, TRUE,
        _T("CTestProject_Sender_E1App"));
