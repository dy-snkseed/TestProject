...
// TestProject_WSClient.cpp : Определяет поведение классов для приложения.
//
...
// создание CTestProject_WSClientApp
...
// Единственный объект CTestProject_WSClientApp

CTestProject_WSClientApp theApp;


// инициализация CTestProject_WSClientApp
